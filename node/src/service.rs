...
//! This module sets up the complete node including:
//! - Transaction pool
//! - Import queue with Aura verification  
//! - Block authorship with Aura
...
pub fn new_full(config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    // Start block authorship with Aura if authority
    if role.is_authority() {
        ...
        log::info!("Block authorship enabled (Aura)");
    }

    // Start Grandpa finality if enabled and authority
    if enable_grandpa {
